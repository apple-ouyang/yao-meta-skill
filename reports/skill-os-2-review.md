...
| Trust | `0` secret findings, `1` pinned dependency file, `50` declared internal modules, `3 / 3` network-capable scripts covered by bounded host policy, `86 / 86` CLI help smoke checks passing across `136` scripts, source-contract hash scope explicit |
