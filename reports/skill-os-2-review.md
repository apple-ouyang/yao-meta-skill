...
| Trust | `0` secret findings, `1` pinned dependency file, `47` declared internal modules, `3 / 3` network-capable scripts covered by bounded host policy, `86 / 86` CLI help smoke checks passing across `133` scripts, source-contract hash scope explicit |
