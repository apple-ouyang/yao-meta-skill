...
- internal modules: `12`
- CLI scripts: `72`
- Yao CLI command handlers: `55`
- largest file lines: `1438`
- hotspots: `3`
- blockers: `0`
...
| --- | ---: | --- | --- | --- |
| `scripts/yao.py` | `1438` | `cli-script` | `warn` | Split command handlers by domain while keeping scripts/yao.py as the thin CLI orchestrator. |
